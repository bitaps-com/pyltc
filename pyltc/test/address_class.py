...
class AddressClassTests(unittest.TestCase):
    ...
    def test_is_WIF_valid(self):
        # mainnet
        self.assertEqual(pyltc.PrivateKey("7B56E2B7BD189F4491D43A1D209E6268046DF1741F61B6397349D7AA54978E76",
        ...
        self.assertEqual(pyltc.PrivateKey("L1MU1jUjUwZ6Fd1L2HDZ8qH4oSWxct5boCQ4C87YvoSZbTW41hg4",
                                            compressed=False, testnet=True).wif,
                         'L1MU1jUjUwZ6Fd1L2HDZ8qH4oSWxct5boCQ4C87YvoSZbTW41hg4')
        ...
        self.assertEqual(a.address, '15m65JmFohJiioQbzMWhqFeCS3ZL1KVaNh')
        a = pyltc.Address(p, address_type = "P2SH_P2WPKH")
        ...
        a = pyltc.ScriptAddress(redeem, witness_version=None)
